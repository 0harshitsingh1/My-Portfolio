...
- **Project Showcase** - Detailed display of my best work and accomplishments
- **Professional Layout** - Clean and modern design focused on user experience
...
```bash
git clone https://github.com/0harshitsingh1/My-Portfolio.git
```
...
2. Modify colors and styles in the CSS files
...
- **Mobile** - Single-column layout on screens below 768px

## 🔗 Live Demo

[Visit my portfolio](https://0harshitsingh1.github.io/My-Portfolio/)
